        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    use_global_strikes = table.Column<bool>(type: "boolean", nullable: false),
                    trigger_id = table.Column<Guid>(type: "uuid", nullable: false),
                    member_added_by = table.Column<long>(type: "bigint", nullable: false),
                    action_type = table.Column<int>(type: "integer", nullable: false),
                    planet_id = table.Column<long>(type: "bigint", nullable: false),
                    target_member_id = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_automod_actions", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    message_id = table.Column<long>(type: "bigint", nullable: true),
                    time_triggered = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_automod_logs", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    trigger_words = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_automod_triggers", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    has_custom_bg = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tutorial_state = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_planet_tags", x => new { x.planet_id, x.tag_id });
                    table.ForeignKey(
                        name: "fk_planet_tag_planet_id",
                        column: x => x.planet_id,
                        principalTable: "planets",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_planet_tag_tag_id",
                        column: x => x.tag_id,
                        principalTable: "tags",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2025, 8, 20, 0, 0, 0, 0, DateTimeKind.Local), "Gaming", "gaming" },
                    { 2L, new DateTime(2025, 8, 20, 0, 0, 0, 0, DateTimeKind.Local), "Anime", "anime" },
                    { 3L, new DateTime(2025, 8, 20, 0, 0, 0, 0, DateTimeKind.Local), "Debates", "debates" },
                    { 4L, new DateTime(2025, 8, 20, 0, 0, 0, 0, DateTimeKind.Local), "News", "news" },
                    { 5L, new DateTime(2025, 8, 20, 0, 0, 0, 0, DateTimeKind.Local), "Strategy", "strategy" },
                    { 6L, new DateTime(2025, 8, 20, 0, 0, 0, 0, DateTimeKind.Local), "Action", "action" },
                    { 7L, new DateTime(2025, 8, 20, 0, 0, 0, 0, DateTimeKind.Local), "Manga", "manga" },
                    { 8L, new DateTime(2025, 8, 20, 0, 0, 0, 0, DateTimeKind.Local), "Geek Culture", "geek-culture" },
                    { 9L, new DateTime(2025, 8, 20, 0, 0, 0, 0, DateTimeKind.Local), "Events", "events" },
                    { 10L, new DateTime(2025, 8, 20, 0, 0, 0, 0, DateTimeKind.Local), "Indie Games", "indie-games" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_automod_actions_planet_id",
                table: "automod_actions",
                column: "planet_id");

            migrationBuilder.CreateIndex(
                name: "IX_automod_actions_trigger_id",
                table: "automod_actions",
                column: "trigger_id");

            migrationBuilder.CreateIndex(
                name: "IX_automod_logs_member_id",
                table: "automod_logs",
                column: "member_id");

            migrationBuilder.CreateIndex(
                name: "IX_automod_logs_planet_id",
                table: "automod_logs",
                column: "planet_id");

            migrationBuilder.CreateIndex(
                name: "IX_automod_logs_trigger_id",
                table: "automod_logs",
                column: "trigger_id");

            migrationBuilder.CreateIndex(
                name: "IX_automod_triggers_planet_id",
