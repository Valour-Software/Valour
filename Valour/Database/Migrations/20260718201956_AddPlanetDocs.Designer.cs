...
namespace Valour.Database.Migrations
{
    ...
    [Migration("20260718201956_AddPlanetDocs")]
    partial class AddPlanetDocs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Valour.Database.Planet", b =>
                {
                    ...
                    b.Property<string>("DocsVanity")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasColumnName("docs_vanity");

                    b.Property<bool>("EnableDocs")
                        .HasColumnType("boolean")
                        .HasColumnName("enable_docs");
                    ...
                    b.Property<bool>("PublicDocs")
                        .HasColumnType("boolean")
                        .HasColumnName("public_docs");
                    ...
                    b.HasIndex("DocsVanity")
                        .IsUnique()
                        .HasFilter("docs_vanity IS NOT NULL");
            ...
            modelBuilder.Entity("Valour.Database.PlanetDoc", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("planet_docs", (string)null);
                });

            modelBuilder.Entity("Valour.Database.PlanetDocRevision", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("DocId", "TimeCreated");

                    b.ToTable("planet_doc_revisions", (string)null);
                });
            ...
            modelBuilder.Entity("Valour.Database.PlanetDoc", b =>
                {
                    b.HasOne("Valour.Database.PlanetDoc", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Valour.Database.PlanetDocRevision", b =>
                {
                    b.HasOne("Valour.Database.PlanetDoc", "Doc")
                        .WithMany("Revisions")
                        .HasForeignKey("DocId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
