...
public interface ISharedPlanet : ISharedItem
{
    ...
    public static string GetIconUrl(ISharedPlanet planet, IconFormat format)
    {
        ...
        {
            return AssignPlanetIconColor(planet);                        
        }
