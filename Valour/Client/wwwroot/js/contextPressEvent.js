...
(function (window, document) {
    ...
    function fireLongPressEvent(originalEvent) {
        ...
        const allowClickEvent = this.dispatchEvent(new CustomEvent('contextpress', {
            bubbles: true,
            cancelable: true,
    ...
    function startLongPressTimer(e, skipTimer = false) {
        ...
        if (skipTimer){
            const b = fireLongPressEvent.bind(el, e);
            b.call();
        }
        else {
            // start the timer
    ...
    document.addEventListener('contextmenu', contextMenuHandler, true); // <- skips timer
