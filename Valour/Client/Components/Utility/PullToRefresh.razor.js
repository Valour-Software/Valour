...
export const init = (root, dotnetRef, threshold = 72, maxPull = 144) => {
    const scrollParent = findScrollParent(root);
    const scrollEl = scrollParent ?? document.scrollingElement;
    const listenEl = scrollParent ?? document;
    let enabled = true;
    let startX = 0;
    let startY = 0;
...
//# sourceMappingURL=PullToRefresh.razor.js.map