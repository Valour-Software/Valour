...
public interface ICoreHub
{
    ...
    void NotifyPlanetItemChange(Valour.Sdk.Models.IClientPlanetModel model, int flags = 0);
    void NotifyPlanetItemDelete(Valour.Sdk.Models.IClientPlanetModel model);
