...
namespace WebPush
{
    public class TestWebPushClient : IWebPushClient
    {
        ...
        public TestWebPushClient()
        {

        }

        public TestWebPushClient(HttpClient httpClient)
        {
            _httpClient = httpClient;
        }

        public TestWebPushClient(HttpClientHandler httpClientHandler)
        {
